    ...
    <div class="container-fluid mt-5 ">
        <div class="row">
            ...
            <div class="col-sm-6 bg-dark" style="border-radius: 0px 40px 0px 80px;">
                <h1 class="text-center text-warning hover">Registration Page</h1>
                <form action="registrationphpcode.php" method="post">
                    <div class="row mt-3">
                        <div class="col-sm-6">
                    ...
                    <div class="row mt-3">
                        <div class="col-sm-12">
                            ...
                            <input type="text" name="pass" class="form-control" placeholder="Password" required><br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7 mt-4 mx-4 ">
                            <button class="btn-warning rounded text-light"><a class="text-light nav-link">Registration</a></button>
